...
import com.silasferreira.youtube.model.Video

class HomeAdapter(var listVideo: ArrayList<Video> = arrayListOf()): androidx.recyclerview.widget.RecyclerView.Adapter<HomeAdapter.HomeViewHolder>() {
